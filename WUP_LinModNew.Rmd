...
summary.lm(model.2)
```
The inferential result gave us a Residual standard error of 1.295 in GRIP, and Adjusted R-squared of 0.4053. comparing SIMS and GRIP to SIMS and ARM, ARM is better because it gave us a higher Adjusted R-squared and a  Residual standard error was lowe.
